...
<html>
<head>
<title>Warranty Info - IMAX Tech PC</title>
...
<p class="text">IMAX Tech / Warranty Info</p>
</div>

<div class="textbox">
	<p class="text">What a disaster! Your computer has failed, and you’re too busy to take it to the shop to get it ﬁx. Lucky for you, you’re covered with the IMAX TECH Pick-up & Return Service! 
	...
	<ul style="list-style:none;content:bullet;color:white">
		...
		<br><li class="text">Shipping and service charges may be applicable IF hardware tested non faulty and / or caused by hardware not purchased from IMAX Tech PC, 
			the final decision lies with the staffs of IMAX Tech PC.</li>
		<br><li class="text">Please take note that The FREE PICKUP AND RETURN SERVICES covers all the products purchased from IMAX Tech PC and is still under warranty only.</li>
