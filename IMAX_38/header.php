...
<head>
  ...
  <link rel="icon" type="image/png" style="border-radius: 50%;" href="./static/LOGOOO.png"/>
</head>
...
<div class="nav-wrapper" style="height: 100px">
  <nav style="height: 100px;">
    <div class="nav-wrapper" style="height: 100px;">
      <a href="index.php" class="logo-link"><img src = "./static/LOGOOO.png" alt="logo" id="logo" class="brand-logo glow-image"/></a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li id="search-bar">
          <form action="product_catalogue.php">
            <div class="search-row">
              <input type="text" name="query" placeholder="Browse products..."
                class="autocomplete" id="autocomplete-input"
                value="<?php if (isset($_GET["query"])) echo($_GET["query"]); ?>"
              />
              <button type="submit" value='<?php if (isset($_GET["query"])) echo($_GET["query"]); ?>'>
        ...
        <?php
          ...
          <?php if ($privilegeLevel == 1)
            echo("<li><a class='header-btn secondary' href='admin.php' target='_blank'>Admin Panel</a></li>");
          echo
            ("
            <li>
              <a class='header-btn secondary' href='cart.php?member_id=$memberID'>
                Cart<span class='badge' id='cart_badge'>$orderItemCount</span></a>
            </li>
