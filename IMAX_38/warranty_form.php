...
<head>
<title>Warranty form - IMAX Tech</title>
...
<p class="text">IMAX Tech / Warranty Form</p>
</div>
...
<div class="textbox">
	<p class="text">What a disaster! Your computer has failed, and you’re too busy to take it to the shop to get it ﬁx. Lucky for you, 
		you’re covered with the IMAX TECH Pick-up & Return Service! We’ll pick-up your computer or hardware or replace it, and bring it back to you at your convenience, saving you time and money.</p>
	<br><br>
	<form method="post">
	<table class="text">
		<tr>
